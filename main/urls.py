...
urlpatterns = [
    ...
    path('inventory/new/', inventory.inventory_new, name='inventory_new'),
    path('inventory/edit/<int:pk>/', inventory.inventory_edit, name='inventory_edit'),
    ...
    path('inventory/download_jpinvoice/<int:id>/', inventory.download_jpinvoice, name='download_jpinvoice'),
    path('inventory/download_proforma_invoice/<int:id>/', inventory.download_proforma_invoice, name='download_proforma_invoice'),
