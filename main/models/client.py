...
class Client(models.Model):
    ...
    pic1 = models.CharField(verbose_name="担当者1", blank=True, null=True, max_length=256)
    pic2 = models.CharField(verbose_name="担当者2", blank=True, null=True, max_length=256)
    pic3 = models.CharField(verbose_name="担当者3", blank=True, null=True, max_length=256)
    pic4 = models.CharField(verbose_name="担当者4", blank=True, null=True, max_length=256)
    pic5 = models.CharField(verbose_name="担当者5", blank=True, null=True, max_length=256)
