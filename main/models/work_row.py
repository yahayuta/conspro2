...
class WorkRow(models.Model):
    ...
    name = models.CharField(verbose_name="品名", max_length=256)
    ...
    client = models.ForeignKey('Client',on_delete=models.SET_NULL, null=True, db_column='client_id', verbose_name="仕入先", default='1')
